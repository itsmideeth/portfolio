...
export default function WorkExperience() {
  return (
    <section
      className="px-4 py-6 transition-colors duration-300 bg-white sm:px-6 lg:px-8 dark:bg-gray-950"
      id="experience"
    >
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
          {experiences.map((exp, i) => (
            <motion.div
              ...
              className="p-6 transition-all duration-300 border border-gray-100 shadow-sm rounded-2xl hover:shadow-md hover:-translate-y-1"
            >
              <div className="flex items-start gap-4">
                {/* Icon */}
                <div className="flex-none p-3 bg-gray-100 border border-gray-100 rounded-xl dark:border-gray-700">
